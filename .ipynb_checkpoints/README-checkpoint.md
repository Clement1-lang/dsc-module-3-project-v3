...
The goal of this project is to provide data-driven insights that can help a new movie studio make informed decisions when entering the movie industry.

The analysis examines movie genres, domestic box-office performance, IMDb ratings, studio performance, and market trends to identify commercially promising opportunities and potential areas of competition.

The project combines data from IMDb and Box Office Mojo and uses data preparation, exploratory data analysis, statistical summaries, and visualizations to develop actionable business recommendations.

### Project Files

* [Final Analysis Notebook](student.ipynb)
* [Project Presentation](Movie_Analysis_Presentation)
...
A new movie studio is planning to enter the movie industry but faces uncertainty about which types of movies to produce and how to compete effectively.

The studio needs data-driven insights into movie genres, box-office performance, audience ratings, studio performance, and market competition to support better production and investment decisions.

### Stakeholder

The primary stakeholder is the **head and management of the new movie studio**.

The stakeholder can use the findings to make decisions about:
...
The goal is to use historical movie data to identify commercially promising opportunities and provide actionable recommendations that can help the new studio make better decisions about movie production, investment, and release strategy.

### Key Business Questions

1. Which movie genres have the strongest domestic box-office performance?
2. Is there a relationship between IMDb ratings and domestic box-office performance?
3. How does domestic box-office performance differ across studios?
4. Which genres are highly represented and potentially more competitive?
5. What strategies should a new movie studio consider when entering the market?
...
* **IMDb** — movie information, genres, ratings, and number of votes.
* **Box Office Mojo** — domestic gross, foreign gross, studio, and release year.

After combining the relevant datasets, the final analytical dataset contained **1,847 movies and 12 variables**.
...
* `foreign_gross` — foreign box-office revenue
* `year` — release year
...
* Converting `foreign_gross` to a numeric format
* Merging IMDb and box-office data
* Splitting movies with multiple genres into separate genre observations
* Calculating genre-level summary statistics

### Key Findings

#### Finding 1: High-performing genres

Animation, Sci-Fi, and Adventure showed particularly strong domestic box-office performance.

The median domestic gross was:

* Animation — **$85.9M**
* Sci-Fi — **$79.2M**
* Adventure — **$64.7M**

This suggests that these genres may provide commercially promising opportunities for a new studio.

#### Finding 2: IMDb ratings do not guarantee box-office success

The analysis showed substantial variation in domestic box-office performance across IMDb rating levels.

For example, Documentary had a median IMDb rating of **7.4**, but its median domestic gross was only **$527,500**. Animation had a lower median rating of **6.7**, but a much higher median domestic gross of **$85.9M**.

This indicates that IMDb ratings should not be used alone to predict commercial success.

#### Finding 3: Some genres are highly saturated

Drama, Comedy, and Action were the most represented genres in the dataset:

* Drama — **960 movies**
* Comedy — **655 movies**
* Action — **523 movies**

This indicates that these genres may have greater levels of competition.

### Visualizations

The three key visualizations used to communicate the business findings are:

1. **Median Domestic Gross by Genre**
   Shows which genres have stronger typical domestic box-office performance.

2. **IMDb Rating vs Domestic Gross**
   Examines whether higher IMDb ratings correspond to higher domestic box-office performance.

3. **Number of Movies by Genre**
   Shows which genres are more heavily represented and therefore potentially more competitive.
...
The studio should consider investing selectively in strong-performing genres such as Animation, Sci-Fi, and Adventure.

### 2. Do Not Rely on IMDb Ratings Alone

IMDb ratings should be combined with genre performance, competition, and other market evidence when evaluating potential projects.

### 3. Benchmark Successful Studios

The new studio should study successful studios and learn from their distribution, release, and market strategies.

### 4. Explore Less-Saturated Opportunities

The studio should investigate genres outside heavily represented categories such as Drama, Comedy, and Action, particularly where commercial potential is strong.

### 5. Use a Multi-Factor Decision Process

Movie investment decisions should combine genre performance, competition, audience response, market trends, and studio strategy rather than relying on a single metric.

---

## Conclusion

The analysis shows that movie success is influenced by multiple factors rather than one single characteristic.

Animation, Sci-Fi, and Adventure demonstrated strong domestic box-office performance, while Drama, Comedy, and Action were highly represented in the dataset. The analysis also showed that IMDb ratings alone do not guarantee commercial success.

Based on these findings, the new studio should focus on commercially promising genres, investigate less-saturated opportunities, benchmark successful studios, and use a multi-factor data-driven decision process when selecting movies to produce.

These findings can support better-informed strategic decisions, although additional current market research and financial analysis would be needed before making major investments.
